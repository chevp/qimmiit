...
#endif
#if KTX_USE_GETPROC
#include <glew/glew.h> // anstelle von GL/glew
#else
                             ...
                             void *pixels, void *userdata)
{
    ...
    if ((glerror == GL_INVALID_ENUM || glerror == GL_INVALID_VALUE) && (cbData->glInternalformat == GL_ETC1_RGB8_OES || (cbData->glInternalformat >= GL_COMPRESSED_R11_EAC && cbData->glInternalformat <= GL_COMPRESSED_SRGB8_ALPHA8_ETC2_EAC)))
    {
        GLubyte *unpacked;
                    ...
                    GLenum *pGlerror)
{
    ...
    if (!This->isCompressed)
    {
        ...
        if (sizedFormats == _NO_SIZED_FORMATS || (!(sizedFormats & _LEGACY_FORMATS) &&
                                                  (This->glBaseInternalformat == GL_ALPHA || This->glBaseInternalformat == GL_LUMINANCE || This->glBaseInternalformat == GL_LUMINANCE_ALPHA || This->glBaseInternalformat == GL_INTENSITY)))
        {
            cbData.glInternalformat = This->glBaseInternalformat;
        }
#endif
